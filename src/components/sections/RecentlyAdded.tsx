...
function RecentlyAdded() {
  const title =
    '  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora voluptatem officiis vero mollitia dolorem voluptatum blanditiis repudiandae aut architecto ad!';
  return (
    <section className="py-20">
      <Container>
        ...
        <div className="flex justify-center pt-3">
          <button className="px-6 py-3 border-2  border-secondary_color dark:text-white hover:bg-primary_color rounded-md text-color_primary font-semibold">
