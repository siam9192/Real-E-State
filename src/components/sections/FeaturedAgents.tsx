...
function FeaturedAgents() {
  const title =
    '  Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores odio omnis dignissimos odit consectetur dolor reiciendis harum quaerat, doloribus quas.';
  return (
