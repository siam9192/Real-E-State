  ...
  return (
    <div className="p-5  space-y-5 ">
      <div className="relative">
        <img
          src="https://firebasestorage.googleapis.com/v0/b/resido-real-state-9878.appspot.com/o/images%2F93.webp_8559b160-44a2-4808-b327-40489cd31f0f?alt=media&token=2c4638e6-58c0-4e72-bcf6-be9800ed3e7a"
          alt=""
      ...
      <div className="space-y-3">
        ...
        <h1 className="text-black dark:text-dark_text_high_color text-xl ">
          {property.title}
        </h1>
        <div className="flex   gap-2 items-center py-3  dark:text-dark_text_medium_color">
          <div className="flex items-center gap-2 ">
            <div className="p-2   bg-light_highlight_color dark:bg-dark_highlight_color  rounded-full">
